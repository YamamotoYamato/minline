...
3. ダウンロードした `minline-0.1.6.jar` を Minecraft の `mods` フォルダに入れます。
...
候補が取得できる場合は、テキスト入力欄の近くに簡易候補一覧を表示します。`Esc` を押したときや、チャット送信後にチャット欄が閉じたときは、Windows に IME を直接入力へ戻すよう要求します。
