...
3. Put the downloaded `minline-0.1.7.jar` into your Minecraft `mods` folder.
...
When candidates are available, Minline renders a simple candidate list near the text field. Pressing `Esc`, closing chat after sending a message, or returning to the normal game view also asks Windows to switch the IME back to direct input.
